\section{„Ç§„É≥„Çø„Éï„Çß„Éº„Çπ RTC::Fsm}
\label{interfaceRTC_1_1Fsm}\index{RTC::Fsm@{RTC::Fsm}}


{\ttfamily import \char`\"{}RTC.idl\char`\"{};}

RTC::Fsm„Å´ÂØæ„Åô„ÇãÁ∂ôÊâø„Ç∞„É©„Éï\begin{figure}[H]
\begin{center}
\leavevmode
...
\#\#\# [∏Ìø¢] \doxyref{RTC.idl}{p.}{RTC_8idl} §À§œ¥ﬁ§ﬁ§Ï§∆§§§ §§§¨PIM§À§œ¥ﬁ§ﬁ§Ï§∆§§§Î°£ \#\#\# PIM§¨¿µ§∑§§°£ \index{RTC::Fsm@{RTC::Fsm}!get\_\-owned\_\-contexts@{get\_\-owned\_\-contexts}}
...
§≥§Œ \doxyref{RTC}{p.}{namespaceRTC} §¨ΩÍÕ≠§π§Î \doxyref{ExecutionContext}{p.}{interfaceRTC_1_1ExecutionContext} §Œ•Í•π•»§ÚºË∆¿§π§Î°£ \index{RTC::Fsm@{RTC::Fsm}!get\_\-participating\_\-contexts@{get\_\-participating\_\-contexts}}
...
§≥§Œ•Í•π•»§À¥ﬁ§ﬁ§Ï§Îº¬π‘•≥•Û•∆•≠•π•»§œ°¢attach\_\-context §¨∏∆§”Ω– §µ§Ï§Î§¥§»§À°¢•Í•π•»§Àƒ…≤√§µ§Ï°¢detach\_\-context §¨∏∆§”Ω–§µ§Ï§Î§¥ §»§À°¢•Í•π•»§´§È∫ÔΩ¸§µ§Ï§Î°£ \index{RTC::Fsm@{RTC::Fsm}!initialize@{initialize}}
