...
\#\#\# [∏Ìø¢] \doxyref{RTC.idl}{p.}{RTC_8idl} §À§œ¥ﬁ§ﬁ§Ï§∆§§§ §§§¨PIM§À§œ¥ﬁ§ﬁ§Ï§∆§§§Î°£ \#\#\# PIM§¨¿µ§∑§§°£ \index{RTC::FsmParticipant@{RTC::FsmParticipant}!get\_\-owned\_\-contexts@{get\_\-owned\_\-contexts}}
...
§≥§Œ \doxyref{RTC}{p.}{namespaceRTC} §¨ΩÍÕ≠§π§Î \doxyref{ExecutionContext}{p.}{interfaceRTC_1_1ExecutionContext} §Œ•Í•π•»§ÚºË∆¿§π§Î°£ \index{RTC::FsmParticipant@{RTC::FsmParticipant}!get\_\-participating\_\-contexts@{get\_\-participating\_\-contexts}}
...
§≥§Œ•Í•π•»§À¥ﬁ§ﬁ§Ï§Îº¬π‘•≥•Û•∆•≠•π•»§œ°¢attach\_\-context §¨∏∆§”Ω– §µ§Ï§Î§¥§»§À°¢•Í•π•»§Àƒ…≤√§µ§Ï°¢detach\_\-context §¨∏∆§”Ω–§µ§Ï§Î§¥ §»§À°¢•Í•π•»§´§È∫ÔΩ¸§µ§Ï§Î°£ \index{RTC::FsmParticipant@{RTC::FsmParticipant}!initialize@{initialize}}
