...
\begin{DoxyCompactList}\small\item\em \doxyref{PublisherFlush}{p.}{classRTC_1_1PublisherFlush} クラス. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{ネームスペース}
\begin{DoxyCompactItemize}
\item 
namespace {\bf coil}
...
\subsection{説明}
PublisherFlush class. \begin{DoxyDate}{日付}
