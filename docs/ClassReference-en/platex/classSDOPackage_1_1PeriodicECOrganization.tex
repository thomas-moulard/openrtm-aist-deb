\section{SDOPackage::PeriodicECOrganization Class Reference}
...
\doxyref{PeriodicECOrganization}{p.}{classSDOPackage_1_1PeriodicECOrganization} class.  
...
Inheritance diagram for SDOPackage::PeriodicECOrganization:\begin{figure}[H]
\begin{center}
\leavevmode
...
\begin{DoxyCompactList}\small\item\em [CORBA interface] Add Organization member \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em [CORBA interface] Set Organization member \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em [CORBA interface] Remove a member of Organization \item\end{DoxyCompactList}\item 
void {\bf removeAllMembers} (void)
\begin{DoxyCompactList}\small\item\em Remove a member of Organization. \item\end{DoxyCompactList}\item 
void {\bf updateDelegatedPorts} (void)
\begin{DoxyCompactList}\small\item\em Update/Remove a member of Organization. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Conversion from \doxyref{SDO}{p.}{classSDO} to DFC. \item\end{DoxyCompactList}\item 
void {\bf stopOwnedEC} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Stop Owned ExecutionContexts. \item\end{DoxyCompactList}\item 
void {\bf startOwnedEC} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Start Owned ExecutionContexts. \item\end{DoxyCompactList}\item 
void {\bf addOrganizationToTarget} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Set Organization object to target DFC. \item\end{DoxyCompactList}\item 
void {\bf removeOrganizationFromTarget} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Remove Organization object from a target DFC. \item\end{DoxyCompactList}\item 
void {\bf addParticipantToEC} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Set CompositeRTC's ExecutionContext to the given DFC. \item\end{DoxyCompactList}\item 
void {\bf removeParticipantFromEC} ({\bf Member} \&member)
\begin{DoxyCompactList}\small\item\em Remove participant DFC from CompositeRTC's ExecutionContext. \item\end{DoxyCompactList}\item 
void {\bf addPort} ({\bf Member} \&member, PortList \&portlist)
\begin{DoxyCompactList}\small\item\em Delegate given RTC's ports to the Composite. \item\end{DoxyCompactList}\item 
void {\bf removePort} ({\bf Member} \&member, PortList \&portlist)
\begin{DoxyCompactList}\small\item\em Remove delegated participatns's ports from the composite. \item\end{DoxyCompactList}\item 
void {\bf updateExportedPortsList} (void)
\begin{DoxyCompactList}\small\item\em PortsList is updated. \item\end{DoxyCompactList}\item 
void {\bf print} (PortList p)
\begin{DoxyCompactList}\small\item\em Output PortList to StandardOutput. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Protected Attributes}
\begin{DoxyCompactItemize}
\item 
{\bf RTC::Logger} {\bf rtclog}
\begin{DoxyCompactList}\small\item\em Logger stream. \item\end{DoxyCompactList}\item 
::{\bf RTC::RTObject\_\-impl} $\ast$ {\bf m\_\-rtobj}
\begin{DoxyCompactList}\small\item\em RT Object. \item\end{DoxyCompactList}\item 
::RTC::ExecutionContext\_\-var {\bf m\_\-ec}
\begin{DoxyCompactList}\small\item\em ExecutionContext Object reference. \item\end{DoxyCompactList}\item 
std::vector$<$ {\bf Member} $>$ {\bf m\_\-rtcMembers}
\begin{DoxyCompactList}\small\item\em \doxyref{Member}{p.}{classSDOPackage_1_1PeriodicECOrganization_1_1Member} list. \item\end{DoxyCompactList}\item 
...
\doxyref{PeriodicECOrganization}{p.}{classSDOPackage_1_1PeriodicECOrganization} class. Implement of Organization\_\-imp 
...
\item[{\em rtobj}]Object \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em sdo\_\-list}]\doxyref{SDO}{p.}{classSDO} member list to be added \end{DoxyParams}
\begin{DoxyReturn}{Returns}
boolean will returned if the operation succeed 
\end{DoxyReturn}


Reimplemented from {\bf SDOPackage::Organization\_\-impl} \doxyref{}{p.}{classSDOPackage_1_1Organization__impl_a5a7e771a78dce198f23e6045f9073be3}.
...
This operation removes a \doxyref{SDO}{p.}{classSDO} from existing member list by specified ID.


\begin{DoxyParams}{Parameters}
\item[{\em id}]The ID of the \doxyref{SDO}{p.}{classSDO} to be removed \end{DoxyParams}
\begin{DoxyReturn}{Returns}
boolean will returned if the operation succeed 
\end{DoxyReturn}


Reimplemented from {\bf SDOPackage::Organization\_\-impl} \doxyref{}{p.}{classSDOPackage_1_1Organization__impl_ad5b844e581d3c48d8a0d039d40f8c7f2}.
...
Conversion from \doxyref{SDO}{p.}{classSDO} to DFC. 
...
\begin{DoxyParams}{Parameters}
\item[{\em sdo\_\-list}]\doxyref{SDO}{p.}{classSDO} member list to be set \end{DoxyParams}
\begin{DoxyReturn}{Returns}
boolean will returned if the operation succeed 
\end{DoxyReturn}


Reimplemented from {\bf SDOPackage::Organization\_\-impl} \doxyref{}{p.}{classSDOPackage_1_1Organization__impl_aa08d0464d1bb97686e0f5e1e4bae78b9}.
...
\doxyref{Member}{p.}{classSDOPackage_1_1PeriodicECOrganization_1_1Member} list. 
...
Reimplemented from {\bf SDOPackage::Organization\_\-impl} \doxyref{}{p.}{classSDOPackage_1_1Organization__impl_a47d0b3ab2bda09862034e71a06ea5c6f}.
