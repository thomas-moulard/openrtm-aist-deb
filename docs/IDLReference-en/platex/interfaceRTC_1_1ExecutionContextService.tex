...
While the context is Running, all Active RTCs participating in the context shall be executed according to the context¡Çs execution kind. \index{RTC::ExecutionContextService@{RTC::ExecutionContextService}!remove\_\-component@{remove\_\-component}}
