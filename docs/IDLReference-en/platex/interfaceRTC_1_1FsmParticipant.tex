...
This operation is intended to be invoked by ExecutionContextOperations::add\_\-component (see Section 5.2.2.6.6). It is not intended for use by other clients. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!detach\_\-context@{detach\_\-context}}
...
\end{DoxyItemize}\index{RTC::FsmParticipant@{RTC::FsmParticipant}!exit@{exit}}
...
An \doxyref{RTC}{p.}{namespaceRTC} cannot be exited if it has not yet been initialized. Any attempt to exit an \doxyref{RTC}{p.}{namespaceRTC} that is in the Created state shall fail with ReturnCode\_\-t::PRECONDITION\_\-NOT\_\-MET. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!finalize@{finalize}}
...
\end{DoxyItemize}\index{RTC::FsmParticipant@{RTC::FsmParticipant}!get\_\-context@{get\_\-context}}
...
\subsection{Description}\label{namespaceRTC_Description}
This operation returns a handle that is associated with the given execution context. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!get\_\-owned\_\-contexts@{get\_\-owned\_\-contexts}}
...
\subsection{Description}\label{namespaceRTC_Description}
This operation returns a list of all execution contexts owned by this \doxyref{RTC}{p.}{namespaceRTC}. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!get\_\-participating\_\-contexts@{get\_\-participating\_\-contexts}}
...
Each call to attach\_\-context causes the provided context to be added to this list. Each call to detach\_\-context causes the provided context to be removed from this list. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!initialize@{initialize}}
...
\item Application developers are not expected to call this operation directly; it exists for use by the \doxyref{RTC}{p.}{namespaceRTC} infrastructure. 
\end{DoxyItemize}\index{RTC::FsmParticipant@{RTC::FsmParticipant}!is\_\-alive@{is\_\-alive}}
...
This callback is invoked only a single time for time that the \doxyref{RTC}{p.}{namespaceRTC} transitions into the Error state from another state. This behavior is in contrast to that of on\_\-error. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-action@{on\_\-action}}
...
\end{DoxyItemize}\index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-activated@{on\_\-activated}}
...
\subsection{Description}\label{namespaceRTC_Description}
The \doxyref{RTC}{p.}{namespaceRTC} has been activated in the given execution context. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-deactivated@{on\_\-deactivated}}
...
\subsection{Description}\label{namespaceRTC_Description}
The \doxyref{RTC}{p.}{namespaceRTC} has been deactivated in the given execution context. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-error@{on\_\-error}}
...
\end{DoxyItemize}\index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-finalize@{on\_\-finalize}}
...
Any final RTC-\/specific tear-\/down logic should be performed here. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-initialize@{on\_\-initialize}}
...
Any RTC-\/specific initialization logic should be performed here. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-reset@{on\_\-reset}}
...
\subsection{Description}\label{namespaceRTC_Description}
The given execution context, in which the \doxyref{RTC}{p.}{namespaceRTC} is participating, has transitioned from Running to Stopped. \index{RTC::FsmParticipant@{RTC::FsmParticipant}!on\_\-startup@{on\_\-startup}}
