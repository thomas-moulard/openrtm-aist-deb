\section{RTC::ComponentAction Interface Reference}
\label{interfaceRTC_1_1ComponentAction}\index{RTC::ComponentAction@{RTC::ComponentAction}}


\doxyref{ComponentAction}{p.}{interfaceRTC_1_1ComponentAction}.  
...
Inheritance diagram for RTC::ComponentAction:\begin{figure}[H]
\begin{center}
\leavevmode
...
\doxyref{ComponentAction}{p.}{interfaceRTC_1_1ComponentAction}. \subsection{Description}\label{namespaceRTC_Description}
The \doxyref{ComponentAction}{p.}{interfaceRTC_1_1ComponentAction} interface provides callbacks corresponding to the execution of the lifecycle operations of \doxyref{LightweightRTObject}{p.}{interfaceRTC_1_1LightweightRTObject} (see Section 5.2.2.2) and \doxyref{ExecutionContext}{p.}{interfaceRTC_1_1ExecutionContext} (see Section 5.2.2.5). An \doxyref{RTC}{p.}{namespaceRTC} developer may implement these callback operations in order to execute application-\/specific logic pointing response to those transitions.\subsection{Semantics}\label{namespaceRTC_Semantics}
Clients of an \doxyref{RTC}{p.}{namespaceRTC} are not expected to invoke these operations directly; they are provided for the benefit of the \doxyref{RTC}{p.}{namespaceRTC} middleware implementation. 
...
This callback is invoked only a single time for time that the \doxyref{RTC}{p.}{namespaceRTC} transitions into the Error state from another state. This behavior is in contrast to that of on\_\-error. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-activated@{on\_\-activated}}
...
\subsection{Description}\label{namespaceRTC_Description}
The \doxyref{RTC}{p.}{namespaceRTC} has been activated in the given execution context. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-deactivated@{on\_\-deactivated}}
...
\subsection{Description}\label{namespaceRTC_Description}
The \doxyref{RTC}{p.}{namespaceRTC} has been deactivated in the given execution context. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-error@{on\_\-error}}
...
\end{DoxyItemize}\index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-finalize@{on\_\-finalize}}
...
Any final RTC-\/specific tear-\/down logic should be performed here. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-initialize@{on\_\-initialize}}
...
Any RTC-\/specific initialization logic should be performed here. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-reset@{on\_\-reset}}
...
\subsection{Description}\label{namespaceRTC_Description}
The given execution context, in which the \doxyref{RTC}{p.}{namespaceRTC} is participating, has transitioned from Running to Stopped. \index{RTC::ComponentAction@{RTC::ComponentAction}!on\_\-startup@{on\_\-startup}}
